...
1. [ ] Работа с пользователем:
	1. [ ] Доработать структуру таблицы User:
		- [ ] уточнить размеры полей
		- [ ] login или email?
		- [ ] решить в каком виде хранить пароль
	2. [ ] Реализация функциональности работы с пользователем:
		- [ ] Создание
		- [ ] Аутентификация
		- [ ] Смена пароля
		- [ ] Удаление
